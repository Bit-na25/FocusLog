    ...
    <div>
      <div className="relative w-full" ref={dropdownRef}>
        ...
        <button
          ...
          className={`w-full flex items-center justify-between border p-2 rounded mb-1 ${dropdownOpen && "focus:ring-2 focus:ring-primary"}`}
        >
          ...
          <div className="absolute z-10 w-full h-48 border rounded shadow bg-white overflow-auto ">
            {categories.map((c) => (
              <div
                ...
                className={`flex items-center gap-2 px-4 py-2 ${selectedCategory.id === c.id ? "bg-primary/80 text-white" : "hover:bg-primary/10"} cursor-pointer`}
              >
